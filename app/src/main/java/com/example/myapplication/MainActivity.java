...
//    static ArrayList<Article> listphotos;
...
//                }
//                gridView = findViewById(R.id.gridview);
//                ArticleAdapter adapter = new ArticleAdapter(listphotos,getApplicationContext());
...
//        ArrayList<Article> photos = (ArrayList<Article>) listphotos.clone();
